...
当开发session结束时，请执行以下文档更新任务：

**使用方法**：将以下prompt发送给AI：
```
请执行对话结束时的文档更新任务：

1. 更新 docs/current_development_status.md：
   - 记录本次session的进展
   - 更新技术尝试结果
   - 调整下一步计划

2. 更新 CHANGELOG.md：
   - 为今天(YYYY-MM-DD)创建新的版本条目
   - 记录新增功能、修复和变更
   - 遵循现有格式风格
...
请基于本次对话的内容和项目当前状态完成这些更新。
```

**简化版本**（用于快速更新）：
```
生成（或更新）今天的开发记录（CHANGELOG），以及README里的程序框架描述（## 项目结构和## 核心文件和文件夹详细说明）
```
